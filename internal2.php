...
$fulll=@mysql_query("select * from table3 where date='".$date."'") or die(mysql_error());
$full=@mysql_query("select * from table3 where rollno='".$rollno."'") or die(mysql_error());
...
?>
<form action="internal1.php" method="post">
