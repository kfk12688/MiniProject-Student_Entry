...
$full=@mysql_query("select * from table2 where rollno='".$rollno."'") or die(mysql_error());
$fulll=@mysql_query("select * from table2 where date='".$date."'") or die(mysql_error());
...
?>
<form action="abs1.php" method="post">
