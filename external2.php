...
$full=@mysql_query("select * from table4 where rollno='".$rollno."'") or die(mysql_error());
$fulll=@mysql_query("select * from table4 where date='".$date."'") or die(mysql_error());
...
while($aaa=mysql_fetch_array($fulll))
{
	...
	<td width='300'>",$aaa['days'],"</td>
	<td width='300'>",$aaa['name'],"</td>
	<td width='300'>",$aaa['rollno'],"</td>
	<td width='300'>",$aaa['cgname'],"</td>
	<td width='300'>",$aaa['event'],"</td>
	<td width='300'>",$aaa['pname'],"</td>
	<td width='300'>",$aaa['orgdate'],"</td></tr>";	
}
	echo"</table>";
?>
<form action="external1.php" method="post">
